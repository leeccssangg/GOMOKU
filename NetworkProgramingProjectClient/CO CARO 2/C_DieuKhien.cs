...
namespace CO_CARO_2
{
    class C_DieuKhien
    {
        ...
        public C_DieuKhien(SocketManager socket)
        {
            this.socket = socket;
                ...
                if (mouseY % C_OCo.CHIEU_CAO != 0 && mouseX % C_OCo.CHIEU_RONG != 0)
                {
                    ...
                    if (MangOCo[dong, cot].SoHuu == 0)
                    {
                        ...
                        if (_ownerLuotdi == 0)
                        {
                                ...
                                BanCo.veQuanCo(g, cot * C_OCo.CHIEU_CAO, dong * C_OCo.CHIEU_RONG, 2);
                                MangOCo[dong, cot].SoHuu = 2;

                            Point point = new Point(cot, dong);
                            socket.Send(new SocketData((int)SocketCommand.CSENT_TURN, " ", point));
                        ...
                        else
                        {
                                ...
                                BanCo.veQuanCo(g, cot * C_OCo.CHIEU_CAO, dong * C_OCo.CHIEU_RONG, 1);
                        ...
                        {
                            MessageBox.Show("Luot di cua doi thu");
                        }
                    }
                }
            }
        ...
        public void danhCoDoiThu(Graphics g, int X, int Y)
        {
        ...
        //chơi với người
        public void choiVoiNguoi(Graphics g, int luotDi)
        {
            //chơi với người
            _cheDoChoi = 1;
            //random lượt đi
         ...
         this._ownerLuotdi = luotDi;
            if (_luotDi == 0)
            {
                /*MessageBox.Show("Red player goes first");*/
                MessageBox.Show("Challenge accepted! You will play first");
            }
            else MessageBox.Show("Challenge accepted! You will play second");
            _sanSang = true;
            //khởi tạo mảng ô cờ
            khoiTaoMangOCo();
            //khởi tạo lại stack
        ...
        public void ketThucTroChoi(C_OCo oco)
        {
            ...
            if (_cheDoChoi == 1)
            {
                if (oco.SoHuu == 1) { 
                    ...
                    if( _ownerLuotdi==1)
                    {
                        socket.Send(new SocketData((int)SocketCommand.CSENT_WIN));
